...
function loadEntries() {
    ...
    Array.from(values).forEach((value, index) => {
        ...
        textContainerOriginal.classList.add('text-container', 'readonly');
        textContainerOriginal.innerHTML = `<div class='styled-text readonly'>${highlightCodes(textWithCodes)}</div>`;
        ...
        textContainerTranslation.classList.add('text-container');
        ...
        copyButton.addEventListener('click', () => {
            translationDiv.innerHTML = textContainerOriginal.innerHTML;
        });
